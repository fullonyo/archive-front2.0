...
/**
 * AssetsTab - Gerenciamento de assets
 * Subtabs: All Assets, Pending Approval, Flagged Assets
 */
const AssetsTab = () => {
  ...
  const renderContent = () => {
    switch (activeSubtab) {
      case 'all':
        return <AllAssetsSubtab onStatsUpdate={loadStats} />;
      case 'pending':
        return <PendingApprovalSubtab onStatsUpdate={loadStats} />;
      case 'flagged':
        return <FlaggedAssetsSubtab onStatsUpdate={loadStats} />;
      default:
        return null;
    }
  };
...
// ============================================
// PENDING APPROVAL SUBTAB
// ============================================

const PendingApprovalSubtab = ({ onStatsUpdate }) => {
...
const AllAssetsSubtab = ({ onStatsUpdate }) => {
  const [assets, setAssets] = useState([]);
  const [loading, setLoading] = useState(false);
...
// ============================================
// FLAGGED ASSETS SUBTAB
// ============================================

const FlaggedAssetsSubtab = () => {
  return (
